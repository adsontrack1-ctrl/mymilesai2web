    ...
    <section style={{padding:'72px 56px 110px',display:'grid',gridTemplateColumns:'1.1fr 1fr',gap:56,alignItems:'center',position:'relative',overflow:'hidden',minHeight:720}}>
      ...
      <div style={{position:'relative',zIndex:2,display:'flex',justifyContent:'center',alignItems:'center',minHeight:680,overflow:'visible'}}>
        ...
        <div style={{position:'relative',flexShrink:0,zIndex:2}}>
          ...
          />
          <div style={{position:'absolute',top:55,left:39,width:128,height:18,background:'#EFEFF4',borderRadius:3,zIndex:4,pointerEvents:'none',display:'flex',alignItems:'center',paddingLeft:3}}>
          ...
          <div style={{position:'absolute',top:440,left:35,width:150,height:18,background:'#FFFFFF',borderRadius:3,zIndex:4,pointerEvents:'none',display:'flex',alignItems:'center',paddingLeft:3}}>
            <span style={{fontFamily:"'DM Sans',system-ui,sans-serif",fontWeight:700,fontSize:11,color:'#111827',letterSpacing:'-0.01em',lineHeight:1}}>Client Office</span>
          </div>
          <div className="hero-card1" style={{position:'absolute',top:56,left:-148,background:'#FFFFFF',border:'1px solid rgba(27,77,219,0.18)',borderRadius:12,padding:'10px 14px',boxShadow:'0 8px 24px rgba(27,77,219,0.10)',width:144,zIndex:3,pointerEvents:'none'}}>
            <div style={{fontSize:11,fontWeight:600,color:'#1B4DDB',fontFamily:"'DM Sans',system-ui,sans-serif",marginBottom:4}}>New trip</div>
  ...
  <div style={{width:340,height:680,background:'#0B0F0E',borderRadius:48,padding:10,boxShadow:'0 50px 120px -30px rgba(11,15,14,0.35), 0 20px 40px -20px rgba(11,15,14,0.2)',position:'relative'}}>
    ...
    <div style={{width:'100%',height:'100%',background:'#F8F9FA',borderRadius:40,overflow:'hidden',position:'relative',display:'flex',flexDirection:'column'}}>
          ...
          <svg viewBox="0 0 160 110" style={{width:200,height:138}}>
            <defs>
              <linearGradient id="hgauge" x1="0" y1="0" x2="1" y2="0">
                <stop offset="0%" stopColor="#1B4DDB"/>
                <stop offset="40%" stopColor="#378ADD"/>
      ...
      <div style={{display:'flex',justifyContent:'space-between',alignItems:'baseline',padding:'6px 18px 8px'}}>
        <span style={{fontFamily:"'DM Sans',system-ui,sans-serif",fontWeight:700,fontSize:15,letterSpacing:'-0.01em'}}>Recent Trips</span>
        <span style={{fontSize:10,color:'#1B4DDB',fontWeight:500}}>See all →</span>
      </div>
      {/* Trip list */}

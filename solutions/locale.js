...
(function () {
  ...
  var STRINGS = {
    US: {
      rate:            '$0.725/mile (2026)',
      rateShort:       '$0.725/mi',
      rateValue:       0.725,
      unit:            'miles',
      unitShort:       'mi',
      currency:        '$',
      complianceLabel: 'Tax-ready',
      auditLabel:      'Audit-ready',
      form1:           '',
      form2:           'Form 2106',
      scheduleForm:    'Schedule C',
      formHeader:      'Form 2106 — 2026',
      trustStrip:      '7 days free · Cancel anytime',
      rateNote:        'At $0.725/mile, the 2026 standard mileage rate.',
      regionLabel:     'United States',
      heroClaim:       'in missed deductions every year.',
      subComplianceNote: 'Exports ready for Schedule C.',
    },
    CA: {
      ...
      form2:           'Form T777',
      scheduleForm:    'T4A',
      formHeader:      '2026 logbook',
      trustStrip:      '7 days free · Cancel anytime',
      rateNote:        'At $0.73/km (first 5,000 km), the 2026 CRA reasonable rate.',
      regionLabel:     'Canada',
      heroClaim:       'in missed deductions every year.',
      subComplianceNote: 'Exports ready for T4A filing.',
    },
  };

const MSAudience = () => {
  ...
  const ic = {
    truck: React.createElement(React.Fragment, null, React.createElement("path", {
      d: "M3 7h11v8H3z"
    ...
    wrench: React.createElement(React.Fragment, null, React.createElement("path", {
      d: "M14 7a4 4 0 0 1-5 5l-6 6 3 3 6-6a4 4 0 0 1 5-5z"
    })),
    heart: React.createElement(React.Fragment, null, React.createElement("path", {
      d: "M20.84 4.6a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.07a5.5 5.5 0 0 0-7.78 7.78L12 21.23l8.84-8.85a5.5 5.5 0 0 0 0-7.78z"
    })),
    car: React.createElement(React.Fragment, null, React.createElement("path", {
      d: "M5 17h14"
    }), React.createElement("path", {
      d: "M5 17v-4l2-5h10l2 5v4"
    }), React.createElement("circle", {
      cx: "7.5",
      cy: "17.5",
      r: "1.5"
    ...
    cam: React.createElement(React.Fragment, null, React.createElement("path", {
      d: "M23 7l-7 5 7 5V7z"
    ...
    map: React.createElement(React.Fragment, null, React.createElement("polygon", {
    ...
    bolt: React.createElement(React.Fragment, null, React.createElement("polygon", {
    ...
    shield: React.createElement(React.Fragment, null, React.createElement("path", {
      d: "M12 2l8 4v6c0 5-3.5 9-8 10c-4.5-1-8-5-8-10V6l8-4z"
    })),
    crane: React.createElement(React.Fragment, null, React.createElement("path", {
      d: "M3 18h18"
    }), React.createElement("path", {
      d: "M6 18V8"
    }), React.createElement("path", {
  ...
  const cards = [{
    t: 'Drivers',
    s: 'Daily routes & multi-stop drops',
    c: '#C9A96E',
    i: 'truck'
  }, {
    t: 'Consultants',
    s: 'Client meetings & site visits',
    c: '#34D399',
    i: 'brief'
  }, {
    t: 'Contractors & Trades',
    s: 'Job sites, supply runs & bids',
    c: '#1B4DDB',
    i: 'wrench'
  }, {
    t: 'Medical & Pharma Reps',
    s: 'Hospital rounds & territory coverage',
    c: '#378ADD',
    i: 'heart'
  }, {
    t: 'Rideshare & Gig Drivers',
    s: 'Uber, Lyft, DoorDash & more',
    c: '#C9A96E',
    i: 'car'
  }, {
    t: 'Photographers',
    s: 'Shoots, events & studio runs',
    c: '#378ADD',
    i: 'cam'
  }, {
    t: 'Real Estate',
    s: 'Showings, inspections & closings',
    c: '#1B4DDB',
    i: 'home'
  }, {
    t: 'Health Aides',
    s: 'Patient visits & care routes',
    c: '#1B4DDB',
    i: 'heart'
  }, {
    t: 'Field Inspectors',
    s: 'Compliance routes & site audits',
    c: '#34D399',
    i: 'map'
  }, {
    t: 'Sales Representatives',
    s: 'Territory coverage & demos',
    c: '#C9A96E',
    i: 'user'
  }, {
    t: 'Electricians & Plumbers',
    s: 'Emergency calls & service jobs',
    c: '#C9A96E',
    i: 'bolt'
  }, {
    t: 'Nonprofit & Charity Workers',
    s: 'Outreach drives & charity miles',
    c: '#378ADD',
    i: 'globe'
  }, {
    t: 'Accountants & Bookkeepers',
    s: 'Client office visits & engagement work',
    c: '#378ADD',
    i: 'chart'
  }, {
    t: 'Insurance Adjusters',
    s: 'Claim sites & damage assessments',
    c: '#1B4DDB',
    i: 'shield'
  }, {
    t: 'Construction Foremen',
    s: 'Site supervision & crew coordination',
    c: '#C9A96E',
    i: 'crane'
  }];
  ...
  const Row = ({
    ...
    }, loop.map((a, i) => React.createElement("div", {
      key: i,
      style: {
        flex: '0 0 300px',
  ...
  return React.createElement("section", {
  ...
  }, "Built for every professional", React.createElement("br", null), "who ", React.createElement("span", {
    style: {
      color: '#C9A96E'
    }
  }, "drives to earn."))), React.createElement("div", {
    style: {
      display: 'flex',
    ...
    style: {
      ...
      bottom: 0,
      width: 120,
      background: 'linear-gradient(to right, #0B0F0E, transparent)',
      pointerEvents: 'none',
      zIndex: 2
    }
  }), React.createElement("div", {
    style: {
      ...
      bottom: 0,
      width: 120,
      background: 'linear-gradient(to left, #0B0F0E, transparent)',
      pointerEvents: 'none',
      zIndex: 2
    }
  })));
...
const MSPricing = () => {
  ...
  }, "One plan. Everything included. Costs less than one forgotten drive per month.")), React.createElement("div", {
    style: {
      display: 'flex',
      justifyContent: 'center',
      maxWidth: 1200,
  ...
  }, "MyMilesAI Pro"), React.createElement("div", {
    style: {
      fontFamily: "'Plus Jakarta Sans',system-ui,sans-serif",
      fontWeight: 700,
      fontSize: 22,
  ...
  }, "Everything a serious driver needs. No tiers, no surprises."), React.createElement("div", {
    style: {
      display: 'flex',
      alignItems: 'baseline',
      gap: 8,
  ...
  }, "$699/yr"), React.createElement("span", {
    style: {
      fontSize: 11,
      color: 'rgba(246,243,238,0.4)',
      fontFamily: 'ui-monospace,\'SF Mono\',Menlo,monospace',
  ...
  }, "founding member")), React.createElement("div", {
    style: {
      display: 'flex',
      alignItems: 'baseline',
      gap: 6,
  ...
  }, "or ", React.createElement("strong", {
    style: {
      color: '#C9A96E'
    }
  }, "$69.99/year"), " \u2014 save ~17%"), React.createElement("div", {
    style: {
      fontSize: 12,
  ...
  }, "7 DAYS FREE \xB7 CANCEL ANYTIME"), React.createElement("a", {
    href: "signup/",
    style: {
      background: '#1B4DDB',
      color: '#FFFFFF',
      ...
      textDecoration: 'none',
      display: 'block',
      boxShadow: '0 12px 28px -10px rgba(27,77,219,0.5)'
    }
  }, "Start Free Trial \u2192"), React.createElement("div", {
    style: {
      display: 'flex',
      flexDirection: 'column',
      gap: 12,
...
const MSBlog = () => {
  const posts = [{
    ...
    read: '6 min',
    d: 'Apr 2026',
    u: 'blog/irs-mileage-rate-2026.html'
  }, {
    cat: 'For Rideshare',
    title: 'Uber drivers: what your 1099-K doesn\'t tell you about deductions',
    read: '9 min',
    d: 'Apr 2026',
    u: 'blog/uber-driver-deductions-2026.html'
  }, {
    cat: 'Audit Prep',
    title: 'What an IRS mileage audit actually looks like (and how to survive)',
    read: '12 min',
    d: 'Mar 2026',
    u: 'blog/irs-mileage-audit-guide.html'
  }, {
    cat: 'For Realtors',
    title: 'Every showing, every open house: the realtor deduction map',
    read: '7 min',
    d: 'Mar 2026',
    u: 'blog/realtor-mileage-deductions.html'
  }];
  return React.createElement("section", {
    style: {
      padding: '120px 56px',
  ...
  }, "\u2014 Journal"), React.createElement("h2", {
    style: {
      fontFamily: "'Plus Jakarta Sans',system-ui,sans-serif",
      fontWeight: 800,
  ...
  }, "Tax guides from people", React.createElement("br", null), "who actually drive for work.")), React.createElement("a", {
    href: "blog.html",
    style: {
      fontSize: 14,
      color: '#0B0F0E',
  ...
  }, "All articles \u2192")), React.createElement("div", {
    style: {
      display: 'grid',
    ...
    style: {
      aspectRatio: '4/3',
      background: `linear-gradient(135deg, hsl(${25 + i * 40},35%,70%), hsl(${25 + i * 40},45%,85%))`,
      borderRadius: 8
    }
  }), React.createElement("div", {
    style: {
  ...
  }, React.createElement("span", null, p.d), React.createElement("span", null, p.read))))));
};
const MSAbout = () => {
  return React.createElement("section", {
    style: {
  ...
  }, "\u2014 About MyMilesAI"), React.createElement("div", {
    style: {
      display: 'grid',
  ...
  }, "Built by people who got tired of losing deductions."), React.createElement("div", {
    style: {
      fontSize: 16,
      lineHeight: 1.7,
      color: '#374151',
    ...
    label: 'Built for real workers',
    desc: 'Not enterprise fleet management. Built for freelancers, realtors, and gig drivers.'
  ...
  }, v.desc)))), React.createElement("div", {
    style: {
      display: 'flex',
      gap: 16,
      flexWrap: 'wrap',
  ...
  }, "Questions? We're real people."), React.createElement("a", {
...
const MSCTA = () => React.createElement("section", {
  style: {
    padding: '120px 56px',
    background: 'radial-gradient(ellipse at 50% 100%, rgba(27,77,219,0.12), transparent 60%), #0B0F0E',
    color: '#F8F9FA',
    textAlign: 'center',
    position: 'relative',
    overflow: 'hidden'
...
}, "The next mile you drive", React.createElement("br", null), "could be ", React.createElement("span", {
  style: {
    color: '#C9A96E'
  }
}, "deductible.")), React.createElement("p", {
  style: {
    fontSize: 20,
    color: 'rgba(246,243,238,0.65)',
    maxWidth: 520,
...
}, "Your first 7 days are free. Cancel anytime from the app."), React.createElement("p", {
  style: {
    fontSize: 15,
    color: 'rgba(246,243,238,0.4)',
    maxWidth: 520,
...
}, "Switching from MileIQ? We support CSV import."), React.createElement("div", {
  style: {
    display: 'flex',
    gap: 12,
    justifyContent: 'center',
...
const MSFooter = () => React.createElement("footer", {
  style: {
...
}, React.createElement("div", null, React.createElement(MSLogo, {
  onDark: true,
  size: 22
...
}, c.h), c.l.map(x => React.createElement("a", {
  key: x.t,
  href: x.u,
  style: {
    display: 'block',
...
}, "Disclaimer:"), " MyMilesAI is a recordkeeping tool, not a tax preparer or tax-advice service. Mileage rates and deduction calculations shown are based on publicly available guidance and may not reflect your specific tax situation. Consult a qualified tax professional for tax advice. Use of MyMilesAI does not guarantee tax-authority acceptance of your records or your tax return."));
window.MSAudience = MSAudience;
window.MSTestimonials = MSTestimonials;
window.MSPricing = MSPricing;
window.MSBlog = MSBlog;
window.MSAbout = MSAbout;
window.MSCTA = MSCTA;
